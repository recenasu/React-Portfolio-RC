    ...
    return (
        <div style={styles.projectCardParentContainer}>
                <div style={styles.projectCardTop}>
                    ...
                    <a href="https://watch.screencastify.com/v/3ld63bqd0t60nh5eCyju"><img style={styles.projectCardThumbnail} src='/src/assets/svg-logo-maker.gif' alt='GIF' /></a>
                ...
                <div style={styles.projectCardTop}>
                    ...
                    <a href="https://crazy-good-mvc-tech-blog-d7c213925153.herokuapp.com/"><img style={styles.projectCardThumbnail} src='/src/assets/mvc-tech-blog.gif' alt='GIF' /></a>
                ...
                <div style={styles.projectCardTop}>
                    ...
                    <a href="https://watch.screencastify.com/v/tvBIrl4Ir9KbS0vqILVO"><img style={styles.projectCardThumbnail} src='/src/assets/nosql-social-network.gif' alt='GIF' /></a>
                ...
                <div style={styles.projectCardTop}>
                    ...
                    <a href="https://watch.screencastify.com/v/V8q7zN1n2WOG6oKefMyZ"><img style={styles.projectCardThumbnail} src='/src/assets/employee-tracker.gif' alt='GIF' /></a>
                ...
                <div style={styles.projectCardTop}>
                    ...
                    <a href="https://recenasu.github.io/06-Weather-Dashboard-Project/"><img style={styles.projectCardThumbnail} src='/src/assets/weather-dashboard.gif' alt='GIF' /></a>
                ...
                <div style={styles.projectCardTop}>
                    <div>Coding Quiz</div>
                    <a href="https://recenasu.github.io/04-Coding-Quiz-Project/"><img style={styles.projectCardThumbnail} src='/src/assets/coding-quiz.gif' alt='GIF' /></a>
